	...
	.directive(
		...
		["$timeout", "VG_STATES", "VG_EVENTS", function($timeout, VG_STATES, VG_EVENTS){
			return {
				...
				require: "^videogular",
				transclude: true,
				templateUrl: "/bower_components/videogular-controls/controls.html",
				scope: {
					autoHide: "=vgAutohide",
	...
	.directive(
		...
		["VG_STATES", "VG_EVENTS", function(VG_STATES, VG_EVENTS) {
			return {
				restrict: "E",
				require: "^videogular",
				templateUrl: "/bower_components/videogular-controls/play-pause-button.html",
				scope: {
					vgPlayIcon: "=",
					vgPauseIcon: "="
				},
	...
	.directive(
		...
		["VG_EVENTS", "VG_UTILS", function(VG_EVENTS, VG_UTILS) {
			return {
				restrict: "E",
				require: "^videogular",
				templateUrl: "/bower_components/videogular-controls/volume-bar.html",
				link: function(scope, elem, attr, API) {
	...
	.directive(
		...
		["VG_EVENTS", function(VG_EVENTS) {
			return {
				...
				templateUrl: "/bower_components/videogular-controls/mute-button.html",
				link: function(scope, elem, attr, API) {
	...
	.directive(
		...
		["$window", "VG_EVENTS", function($window, VG_EVENTS){
			return {
				...
				templateUrl: "/bower_components/videogular-controls/full-screen-button.html",
				link: function(scope, elem, attr, API) {
